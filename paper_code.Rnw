...
cut.ssig <- 3.179
cut.crel <- 5
pp.go2 <- 1- pnorm(cut.crel, t.d, sd2)
pp.ngo2 <- pnorm(cut.ssig, t.d, sd2)
...
# par(mfrow=c(1,2))
# 
# plot(t.d, pp.go1, type="l", xlab= expression(delta), ylab="Probability", main="n=27", col="green", ylim=c(0,1))
...
# abline(v=0.8, lty=1)
# 
# plot(t.d, pp.go2, type="l", xlab= expression(delta), ylab="Probability", main="n=65", col="green", ylim=c(0,1))
